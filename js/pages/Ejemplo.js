...
/**
 * Construye el HTML de una fila de usuario para la tabla de ejemplo.
 * @param {object} user
 * @returns {string}
 */
...
/**
 * Abre el modal de edición para un usuario, rellena el formulario con los
 * datos obtenidos desde la API y guarda el email original para comparar.
 * @param {string} correo
 */
...
/**
 * Manejador del submit del formulario de edición: captura los campos,
 * prepara `updatedData` y llama a `userService.updateUser`.
 */
...
/**
 * Delegado de eventos para la tabla: detecta clicks en el botón de editar
 * y llama a `openEditModal` con el email correspondiente.
 */
...
/**
 * Manejador para los switches de estado de usuario. Confirma la acción
 * con el usuario y llama al servicio para cambiar el estado.
 */
...
/**
 * Manejador del submit del formulario de creación: construye el objeto
 * `newUserData`, llama al servicio para crear el usuario y actualiza la UI.
 */
...
/**
 * Inicializa el módulo de ejemplo: carga usuarios, renderiza la tabla y
 * registra los handlers de eventos para edición/creación/estado.
 */
async function init() {
